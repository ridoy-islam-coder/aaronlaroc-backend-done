...
import { AdminEmail, alldatapercentage, codeverify,   deleteUserController,   forgetPassword, getAllOwnUserDataController, GetAllProfile, getAllProxysetController, getCounts, getNewUsersLast10Days, GetProfileData, loginUser, ProfileUpdate, ProxysetController, registerUser, Searchbar, updateUserController, UserAnalysisController, UserList,  } from "./user.controller";
...
router.get("/user", auth, getAllOwnUserDataController);
