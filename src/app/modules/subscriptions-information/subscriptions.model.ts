...
const subscriptionSchema = new Schema<ISubscription, SubscriptionModel>({
    ...
    currentPeriodStart: { type: Date, required: true }, // <-- Date type
    currentPeriodEnd: { type: Date, required: true },   // <-- Date type
    remaining: { type: Number, required: true },
    status: { type: String, enum: ['expired', 'active', 'cancel', 'deactivated'], default: 'active', required: true },
}, {
    timestamps: true,
});
